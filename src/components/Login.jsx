...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error(error);
      let errorMessage = 'An error occurred while signing in. Please try again later.';
      if (error.code === 'auth/user-not-found') {
        errorMessage = 'No user with that email was found. Please try again or sign up first.';
